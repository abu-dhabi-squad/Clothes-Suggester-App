...
class ApiWeatherDataSource : WeatherDataSource {
    override suspend fun getWeatherByCoordinate(coordinate: Coordinate): DtoWeather {
        ...
        val response = client.get("https://api.open-meteo.com/v1/forecast?latitude=${coordinate.latitude}&longitude=${coordinate.longitude}&daily=weather_code,temperature_2m_max,temperature_2m_min&hourly=temperature_2m,weather_code&current=weather_code,temperature_2m")
